...
exports.informAboutApplicationInGenericRepresentation = function (user, originator, xCorrelator, traceIndicator, customerJourney) {
  return new Promise(async function (resolve, reject) {
    ...
    try {
      ...
      let consequentActionForReleaseHistory = new consequentAction(LabelForReleaseHistory, requestForReleaseHistory,false);
      let consequentActionForAPIDocumentation = new consequentAction(LabelForAPIDocumentation, requestForAPIDocumentation,true);
